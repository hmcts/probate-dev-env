...
#Create all the role
$BIN_FOLDER/bin/idam-role.sh caseworker
$BIN_FOLDER/bin/idam-role.sh caseworker-probate
$BIN_FOLDER/bin/idam-role.sh caseworker-probate-issuer
$BIN_FOLDER/bin/idam-role.sh caseworker-probate-solicitor
$BIN_FOLDER/bin/idam-role.sh caseworker-probate-authoriser
$BIN_FOLDER/bin/idam-role.sh caseworker-probate-systemupdate
$BIN_FOLDER/bin/idam-role.sh caseworker-probate-caseofficer
$BIN_FOLDER/bin/idam-role.sh caseworker-probate-caseadmin
$BIN_FOLDER/bin/idam-role.sh caseworker-probate-registrar
$BIN_FOLDER/bin/idam-role.sh caseworker-probate-superuser
$BIN_FOLDER/bin/idam-role.sh caseworker-probate-bulkscan
$BIN_FOLDER/bin/idam-role.sh caseworker-probate-scheduler
$BIN_FOLDER/bin/idam-role.sh payment
$BIN_FOLDER/bin/idam-role-assignable.sh ccd-import
