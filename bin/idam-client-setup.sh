...
curl -XPUT \
 ...
 -H "Authorization: AdminApiAuthToken ${authToken}" \
 -H "Content-Type: application/json" \
 -d '["ccd-import", "caseworker", "pui-case-manager", "caseworker-probate", "caseworker-probate-solicitor", "caseworker-probate-superuser"]'
